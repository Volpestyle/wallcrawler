...
import { WallCrawlerLogEntry } from "../types/logging";
...
class WallCrawlerLogger implements Logger {
  ...
  constructor(private category: string, private sessionId?: string) {}
  ...
  private log(
    ...
    const entry: WallCrawlerLogEntry = {
      ...
      ...(auxiliary ? { auxiliary: this.formatAuxiliary(auxiliary) } : {}),
    };
...
export function createLogger(category: string, sessionId?: string): Logger {
